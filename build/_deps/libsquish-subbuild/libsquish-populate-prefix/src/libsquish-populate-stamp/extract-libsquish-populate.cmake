...
#
get_filename_component(filename "/home/runner/work/UABE/UABE/fetchcontent/libsquish-1.15.tgz" ABSOLUTE)
get_filename_component(directory "/home/runner/work/UABE/UABE/fetchcontent/libsquish-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-libsquish-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-libsquish-populate${i}")
